...
function MobileNav() {
  ...
  <Link href='/' className='flex items-center gap-1'>
      ...
      <p className='text-[26px] font-extrabold text-white'>FYP</p>
      </Link>
      <div className='flex h-[calc(100ch-72px)] flex-col justify-between overflow-y-auto'>
